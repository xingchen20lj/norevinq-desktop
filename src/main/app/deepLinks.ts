...
const DEEP_LINK_SCHEME = 'norevinq:'
...
export function parseNorevinqDeepLink(raw: string, registry: DeepLinkRegistry): DeepLinkTarget | null {
...
export function extractNorevinqDeepLinks(argv: readonly string[]): string[] {
