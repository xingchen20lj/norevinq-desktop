...
| 区域 | 目标行为 | 当前状态 |
|---|---|---|
| 左侧导航 | 项目/任务列表、计划任务、安全、设置；支持折叠、固定、未读与运行状态 | 部分实现：真实列表、64 px 折叠、选择、运行标识和计划未读；项目/任务固定待开发 |
...
| 顶栏 | 项目/工作树上下文、任务标题、Handoff、Git/终端/预览入口 | 部分实现：真实分支、变更计数、Git、终端和文件预览入口；Handoff 待开发 |
