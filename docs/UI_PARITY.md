...
| 区域 | 目标行为 | 当前状态 |
|---|---|---|
| 产品身份 | 普通界面、活动作者和任务回答统一使用 Aster；技术信息透明披露上游 | 已测试：新建/恢复/分叉任务注入一致身份指令，顶部、首页、活动、审批与安全工作台完成 Aster 化；单元和 Electron 生命周期验证协议参数，DeepSeek V4 Flash 真实在线回答验证 Aster 身份，许可/诊断继续保留真实上游名称 |
