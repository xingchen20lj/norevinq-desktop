...
| 活动时间线 | agent 消息、推理摘要、命令、文件变更、工具、审批、子任务 | 部分实现：真实文本、官方 imageGeneration 本地图片直显、命令、文件与中断状态已视觉验证；MCP/子任务和大型活动待压测 |
...
| 文件与产物 | 目录、文本/代码、媒体、PDF、智能体产物直达、外部打开 | 部分实现：真实文本/PNG、fileChange 直达及助手消息中 `generated_images` 直接显示已测试；音视频/PDF真实格式矩阵待最终回归 |
