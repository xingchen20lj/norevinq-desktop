...
| 领域 | 功能 | 状态 | 验证/限制 |
|---|---|---|---|
| 桌面基础 | macOS 应用启动 | 尚未开发 | 阶段 1 实机验证 |
| 桌面基础 | Windows 应用启动 | 尚未开发 | 阶段 20 CI 构建，真机待验证 |
| 桌面基础 | 单实例、深链接、窗口状态恢复 | 尚未开发 | Electron 主进程 |
| 桌面基础 | 自动更新 | 尚未研究 | 需确定发布渠道与签名 |
| 桌面基础 | 深色/浅色/跟随系统 | 尚未开发 | 阶段 1、16 |
| 导航 | 项目、任务、计划任务、安全、设置导航 | 尚未开发 | 阶段 1 起 |
| 项目 | 打开真实本地目录 | 尚未开发 | 阶段 3 |
| 项目 | 最近项目和固定项目 | 尚未开发 | 阶段 3 |
| 项目 | 多项目并存 | 尚未开发 | 阶段 3 |
...
| 对话 | 重启后状态恢复 | 尚未开发 | app-server + 本地数据库 |
...
| 测试 | 单元、集成、E2E、桌面冒烟 | 尚未开发 | 阶段 1 起持续建设 |
