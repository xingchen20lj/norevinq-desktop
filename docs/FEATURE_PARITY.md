...
| 测试 | 单元、集成、E2E、桌面冒烟 | 部分实现 | 32 个测试文件 142 项及 V8 全局门槛；官方 Codex 0.147.0 无模型 thread/goal 生命周期集成、离线 Electron 生命周期/固定/深链接/更新/崩溃诊断、配置渠道与普通目录包、挂载 DMG E2E 通过；Windows CI/真机与在线账户恢复待执行 |
