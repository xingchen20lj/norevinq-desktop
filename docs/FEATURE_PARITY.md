...
| 导航 | 项目、任务、计划任务、安全、设置导航 | 部分实现 | 项目/任务、五页安全工作台与四页设置工作台可用；计划任务待接入 |
...
| 测试 | 单元、集成、E2E、桌面冒烟 | 部分实现 | 20 个测试文件至少 88 项；真实 Electron 覆盖 Security preflight、OpenAI、DeepSeek、AGENTS、MCP、审批、Git/diff/worktree 和 PTY 终端 |
